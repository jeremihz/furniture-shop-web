	...
	<div class="banner">
		...
		<div class="search-bar">
				<form action="search.php" method="POST">
					<input type="text" name="qury">
					<button type="submit" name="user_query" value="Search" > Search</button>
				</form>
			</div>
...
<!-- banner-bottom -->
	<div class="banner-bottom">
		<div class="container">
			<h3>Welcome To <span>Target Furniture</span></h3>
			<div class="welcome">
...
<!-- services -->
			<div class="services">
				<div class="col-md-3 services-grid">
					<a href="Store.html"><img src="images/4.jpg" alt=" " class="img-responsive" /></a>
					<div class="services-grd">
						<h4>Sitting room furniture</h4>
						<p>Nairobi at our shops.</p>
						
					</div>
				</div>
				<div class="col-md-3 services-grid">
					<a href="Store.html"><img src="images/5.jpg" alt=" " class="img-responsive" /></a>
					<div class="services-grd services-grd1">
						<h4>Living Room furnitures</h4>
						<p>Get the best from us.</p>
						
					</div>
				</div>
				<div class="col-md-3 services-grid">
					<a href="Store.html"><img src="images/6.jpg" alt=" " class="img-responsive" /></a>
					<div class="services-grd services-grd2">
						<h4>hard wood furnitures</h4>
						<p>we have the best.</p>
						
					</div>
				</div>
				<div class="col-md-3 services-grid">
					<a href="Store.html"><img src="images/7.jpg" alt=" " class="img-responsive" /></a>
					<div class="services-grd services-grd3">
						<h4>Office furnitures</h4>
						<p>visit us and get the best.</p>
